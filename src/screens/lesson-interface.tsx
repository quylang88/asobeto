...
export function LessonInterface({
  ...
  if (showCompletion) {
    ...
    return (
      <div className="fixed inset-0 bg-linear-to-b from-yellow-bright/30 via-background to-green-bright/20 flex flex-col items-center justify-center p-6 pt-safe pb-safe overflow-hidden safe-bottom-bleed">
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
  ...
  return (
    <div className="fixed inset-0 bg-linear-to-b from-blue-soft/20 via-background to-green-bright/10 flex flex-col overflow-hidden safe-bottom-bleed">
