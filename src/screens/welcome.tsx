...
export function WelcomeScreen({ onStart }: WelcomeScreenProps) {
  return (
    <div className="fixed inset-0 h-[100dvh] w-full touch-none overflow-hidden bg-linear-to-b from-blue-soft via-green-bright/20 to-orange-bright/30 pt-safe">
      ...
      {/* Main content */}
      <div className="relative z-10 flex flex-col items-center justify-center h-full w-full px-4 pb-safe">
        {/* Mascot */}
        <motion.div
