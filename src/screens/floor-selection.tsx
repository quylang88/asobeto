...
const floors: Floor[] = [
  {
    ...
    name: "A",
    description: "Con Cá",
    icon: <span className="text-3xl font-black">A</span>,
  ...
  },
  {
    id: 2,
    name: "Ă",
    description: "Mặt Trăng",
    icon: <span className="text-3xl font-black">Ă</span>,
  ...
  },
  {
    ...
    name: "Â",
    description: "Cái Cân",
    icon: <span className="text-3xl font-black">Â</span>,
  ...
  },
  {
    id: 4,
    name: "Ôn Tập",
    description: "Tổng hợp A-Ă-Â",
    icon: <span className="text-3xl font-black">BOSS</span>,
