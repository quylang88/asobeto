...
export function AwnSvg() {
  return (
    ...
    >
      {/* Ears */}
      <path
        d="M12 14 L18 24 L24 16 Z"
        fill="#F97316"
        transform="rotate(-15 18 19)"
      />
      <path
        d="M44 14 L38 24 L32 16 Z"
        fill="#F97316"
        transform="rotate(15 38 19)"
      />
      ...
      {/* Inner Ears Details */}
      <path
        d="M14 16 L18 22 L22 17 Z"
        fill="#FCD34D"
        opacity="0.7"
        transform="rotate(-15 18 19)"
      />
      <path
        d="M42 16 L38 22 L34 17 Z"
        fill="#FCD34D"
        opacity="0.7"
        transform="rotate(15 38 19)"
      />
