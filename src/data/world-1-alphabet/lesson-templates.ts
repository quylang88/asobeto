  ...
  return [
    {
      ...
      introVoice: `Bé hãy lắng nghe thật kỹ cách phát âm chữ cái "${letter}".`,
    ...
    },
    {
      ...
      introVoice: "Bé hãy nghe thật kỹ rồi chọn chữ cái đúng nha.",
    ...
    },
    {
      ...
      introVoice: `Bé hãy nhìn kỹ cách viết chữ cái "${letter}".`,
    ...
    },
    {
      ...
      introVoice: `Bé hãy viết lại chữ cái "${letter}" theo nét mờ nhé.`,
      mainImage: `/assets/tracing/letters/${letterAssetKey}-guide.png`,
      targetLetter: letter,
      targetText: letter,
      scoring: {
